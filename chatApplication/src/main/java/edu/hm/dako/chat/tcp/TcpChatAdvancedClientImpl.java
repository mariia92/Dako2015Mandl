...
public class TcpChatAdvancedClientImpl extends AbstractClient {
    ...
    /**
     * Senden einer Login-Bestaetigung für den initiierdenden Client
     *
    ...
    /**
     * Senden einer Logout-Bestaetigung für den initiierdenden Client
     *
     * @param pdu PDU des initiierenden Clients
     */
    public void sendLogoutEventConfirm(ChatPDU pdu) {
        ...
        try {
            connection.send(confirmPdu);
            log.debug("Logout-Event-Confirm-PDU fuer " + userName + " an Server gesendet um Logout von " + pdu.getEventUserName() + " zu bestätigen");
